 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://endpoint.soap_crud_server.java_ws_server/", wsdlLocation = "http://localhost:8081/ws/users?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://endpoint.soap_crud_server.java_ws_server/", "UserService");
    ...
    public UserEndpoint getUserEndpointPort() {
        return super.getPort(new QName("http://endpoint.soap_crud_server.java_ws_server/", "UserEndpointPort"), UserEndpoint.class);
    }
    ...
    public UserEndpoint getUserEndpointPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpoint.soap_crud_server.java_ws_server/", "UserEndpointPort"), UserEndpoint.class, features);
    }
